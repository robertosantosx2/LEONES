# LOAS — Historia, decisiones y fundamentos del proyecto

**Libre-Open Agentic Stack (LOAS)**
...
LOAS nace de una investigación sobre la **capa agéntica de IA**: el conjunto de componentes que permite que un modelo deje de ser solamente un generador de texto y pueda planificar, usar herramientas, trabajar con archivos, ejecutar tareas de varios pasos, recuperar errores y completar objetivos.

El objetivo no es estudiar agentes de forma puramente teórica ni seleccionar la plataforma más potente en abstracto. El proyecto busca identificar y construir una **pila agentic libre y abierta que pueda ejecutarse realmente en hardware de consumo**.
...
De ahí nace la métrica:

**Libre-Open Agentic Stack Score**

Inicialmente se evita cerrar definitivamente la «A» de Score como una fórmula inmutable. La métrica debe poder evolucionar cuando se incorporen más proyectos y existan datos comparables suficientes para optimizarla.
...
## 5. Pila candidata congelada: LOAS
...
LOAS **no es un proyecto teórico para ricos ni una plataforma pensada exclusivamente para estaciones de trabajo o centros de datos**.
...
Inicialmente se utilizó tok/s como referencia de rendimiento. Después se decidió que LOAS debía pasar de medir únicamente velocidad de generación a medir **tareas agénticas reales**.
...
**10 tok/s es el mínimo de usabilidad LOAS.**
...
Los benchmarks encontrados en Internet pueden servir para **investigación, selección de candidatos e hipótesis**, pero no sustituyen un resultado oficial LOAS.
...
Por eso la arquitectura se entiende como una pila y no como un único programa.

## 16. metaLOAS: convertir LOAS en una red distribuida

Se decidió incorporar **metaLOAS** para que cualquier persona pueda aportar resultados de su propio hardware al repositorio de GitHub.
...
## 17. Privacidad de metaLOAS

Una decisión explícita es que **metaLOAS no debe convertirse en un sistema de recopilación de datos personales**.
...
## 18. Calidad y confianza de los resultados metaLOAS
...
Se decidió que el proyecto completo debe vivir en el repositorio público:

https://github.com/robertosantosx2/LOAS
...
## 20. Qué debe encontrar una persona nueva en LOAS
...
- optimización de la fórmula **Libre-Open Agentic Stack Score**;
...
- resultados masivos procedentes de metaLOAS.

La intención es que los datos permitan mejorar la pila, no que la pila se diseñe para confirmar una conclusión previa.

## 22. Filosofía final

LOAS no pretende demostrar que la IA local es posible en abstracto.
