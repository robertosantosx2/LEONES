...
La salida JSON evita publicar la URL local para respetar la frontera de
privacidad de metaLEONES.
...
def main() -> int:
    ...
    out = {
        ...
        'tool': 'leones-runtime',
        'tool_version': '1.2',
        'status': 'ok' if reachable else 'no_runtime',
        'endpoints': results,
        'next_step': 'infer' if reachable else 'runtime setup',
    }
