...
`record_benchmark.py` y `run_and_record_benchmark.py` han sido trasladados a [`scripts/deprecated/`](deprecated/). Sus pruebas históricas se conservan bajo `tests/deprecated/`. No se deben crear nuevos consumidores de esas interfaces.
