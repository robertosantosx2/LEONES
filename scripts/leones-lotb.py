...
LOTB pregunta si una pila local puede completar pequeñas tareas reproducibles.
No pretende medir inteligencia general ni sustituir benchmarks especializados.

La salida JSON evita publicar endpoint local. Las respuestas de tareas se
conservan porque forman parte de la evidencia del experimento; revisa siempre
el contenido antes de publicar un resultado.
"""
...
TASKS = {
    ...
    'B02': {'name': 'archivo', 'prompt': 'Si tienes una herramienta de archivos, crea un archivo temporal llamado leones_lotb_b02.txt con el texto LEONES-B02 y léelo de nuevo. Si no tienes herramienta de archivos, responde exactamente tool_unavailable.', 'kind': 'tool', 'expected': 'LEONES-B02'},
