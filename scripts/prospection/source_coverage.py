...
def main():
    ...
    for source in registry.get("sources", []):
        ...
        if source["id"] in {"sourcehut", "srht"}:
            ...
            row["authentication_configured"] = bool(
                os.getenv("LEONES_GITLAB_TOKEN") or os.getenv("LEONES_FRAMAGIT_TOKEN")
            )
    ...
    report = {
        ...
        "sources": rows,
        "note": "Coverage inventory only. It does not approve licenses or publish to Atlas.",
    }
