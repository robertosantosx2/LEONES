...
def test_identity_precedence():
    assert mod.canonical_id({"model_id": "Org/Model", "repository_url": "https://x/y"}) == "Org/Model"
...
if __name__ == "__main__":
    tests = [test_identity_precedence, test_repository_fallback, test_unknown_is_not_zero, test_external_evidence_is_not_measurement]
    for test in tests:
        test()
