...
TEXT = {
    ...
    "installation_authorized": {"es": "Instalación autorizada; queda pendiente la instalación/verificación física.", "en": "Installation authorized; physical installation/verification is still pending.", "zh": "安装已授权；实际安装/验证仍待完成。"},
    "physical_install_notice": {"es": "Esta RC2 no instala ODS/Magnitude automáticamente. Completa la instalación mediante la interfaz canónica del stack y verifica físicamente antes de autorizar el benchmark.", "en": "This RC2 does not install ODS/Magnitude automatically. Complete installation through the stack's canonical interface and verify it physically before authorizing the benchmark.", "zh": "此 RC2 不会自动安装 ODS/Magnitude。请通过运行栈的标准接口完成安装，并在授权基准测试前进行实际验证。"},
