...
def _enriched():
    return {
        "candidates": [
            {
                "model_id": "small",
                "local_fit_estimate": {"status": "fit", "estimated_headroom_gb": 4.0},
                "external_evidence": {
                    "hugging_face": {"status": "weights_available"},
                    "artificial_analysis": {"intelligence_index": 1, "context_tokens": 32000, "reasoning": True},
                },
            },
            {
                "model_id": "strong",
                "local_fit_estimate": {"status": "marginal_or_unknown", "estimated_headroom_gb": -2.0},
                "external_evidence": {
                    "hugging_face": {"status": "weights_available"},
                    "artificial_analysis": {"intelligence_index": 6, "context_tokens": 128000, "reasoning": False},
                },
            },
        ]
    }
...
def test_balanced_prefers_fit_when_quality_gain_is_not_enough():
